// =============================================================================
// SenacDoces.Desktop - Helpers/ApiEndpointResolver.cs
// =============================================================================
//  CONCEITO: Descoberta Automática da URL da API
//
// Esta classe resolve AUTOMATICAMENTE a URL correta da API SenacDoces,
...
// ====================================================
//
//   PRIORIDADE 1 — launchSettings.json do projeto SenacDoces.API
...
//   SenacDoces.Desktop/bin/Debug/net8.0-windows/
//
...
{
    /// <summary>
    /// Responsável por descobrir automaticamente a URL base da API DoceCantinho.
    /// Elimina a necessidade de portas hardcoded no código.
    /// </summary>
    /// <remarks>
    /// Ordem de resolução:
    ///   1. launchSettings.json do projeto DoceCantinho.API (desenvolvimento)
    ...
    public static class ApiEndpointResolver
    {
        ...
        /// </summary>
        private const string ApiProjectName = "DoceCantinho.API";
        ...
        public static string? Resolve()
        {
            ...
            Log("   Verifique se DoceCantinho.API/Properties/launchSettings.json existe");
        ...
        /// <summary>
        /// Tenta localizar e parsear o launchSettings.json do projeto SenacDoces.API.
