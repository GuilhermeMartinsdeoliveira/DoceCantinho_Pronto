...
// Seed Identity (roles e usuário admin) e outros dados iniciais
// O SeedData aplica as migrations pendentes antes de inserir dados iniciais.
DoceCantinho.Infrastructure.Identity.SeedData.SeedAsync(app.Services).GetAwaiter().GetResult();
