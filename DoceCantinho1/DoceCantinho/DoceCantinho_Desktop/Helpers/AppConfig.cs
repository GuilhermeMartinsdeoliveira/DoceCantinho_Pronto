// =============================================================================
// SenacDoces.Desktop - Helpers/AppConfig.cs
// =============================================================================
...
//   1. Lê automaticamente o launchSettings.json do SenacDoces.API
...
namespace DoceCantinho.Desktop.Helpers
{
    ...
    public static class AppConfig
    {
        ...
        ///   1. launchSettings.json do SenacDoces.API (desenvolvimento automático)
        ...
        public static string AppName =>
            GetNestedValue("AppSettings", "AppName") ?? "SenacDoces Desktop";
